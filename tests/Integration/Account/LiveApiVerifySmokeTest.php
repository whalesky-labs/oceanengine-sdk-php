 ...
 * @coversNothing
 */
final class LiveApiVerifySmokeTest extends TestCase
{
    use LoadsEnvConfig;

    public function testAccountInfoLiveRequestWithTlsVerifyEnabled(): void
    {
        ...
        $payload = $this->assertIntegrationHttpResponse($response, '开启 TLS 校验后获取千川广告账户全量信息');

        self::assertArrayHasKey('code', $payload);
        self::assertIsInt($payload['code']);
    }
}
